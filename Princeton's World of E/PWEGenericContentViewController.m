//
//  PWEGenericContentViewController.m
...
@interface PWEGenericContentViewController ()
...
@implementation PWEGenericContentViewController
...
- (void)loadView
{
    [[NSBundle mainBundle] loadNibNamed:@"PWEGenericContentViewController" owner:self options:0];
}
...
- (void)viewDidLoad
{
    ...
    self.descriptionTextView.text = [[(Workshop *)self.entity details] details];
}
...
-(void)actionSheet:(UIActionSheet *)actionSheet willDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    NSString *urlString = [[(Workshop *)self.entity details ]url];
